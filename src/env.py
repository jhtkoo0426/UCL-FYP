...
class ClutteredPushGrasp:
    ...
    def generateGaussianNoisePose(self, pose, object_name):
        ...
        sixd_noise = {
            # Baseline noise
            "block": np.insert(np.random.normal(0, 0.005, 5), 1, 0),
            ...
            "mustard_bottle1": np.random.normal(0, 0.01, 6),
            "mustard_bottle2": np.random.normal(0, 0.01, 6),
            "mustard_bottle3": np.random.normal(0, 0.01, 6),
            "bottle1": np.random.normal(0, 0.01, 6),
            "bottle2": np.random.normal(0, 0.01, 6),
            "bottle3": np.random.normal(0, 0.01, 6),
        }
