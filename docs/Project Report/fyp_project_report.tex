...
Chapter 5 documents the development and implementation of the proposed approach using a multilayer perceptron model that attempts to infer good grasp configurations on three primitive object classes from random hand poses, trained on data collected from the Pybullet simulation. The dataset includes tactile sensor readings, random hand poses and geometric features of the target objects.\\
...
\begin{figure}[H]%
    \centering
    \subfloat[\centering Orientation 1]{{\includegraphics[width=7cm]{docs/Project Report/Media/hand_pose1.png} }}%
    \qquad
    \subfloat[\centering Orientation 2]{{\includegraphics[width=7cm]{docs/Project Report/Media/hand_pose2.png} }}%
...
\bibitem{geidenstam}
    S. Geidenstam et al., “Learning of 2d grasping strategies from box-based 3d object approximations.” in Robotics: Science and Systems, vol.
    2008, 2009.

\bibitem{przybylski}
    M. Przybylski, T. Asfour, and R. Dillmann, “Unions of balls for shape approximation in robot grasping,” in IEEE/RSJ Int. Conf. Intell. Rob. Sys. IEEE, 2010, pp. 1592–1599
