...
\begin{figure}[ht]
    ...
    \caption{Kumra and Kanan \cite{8202237}: Robotic Grasp Detection using Deep Convolutional Neural Networks: Example of an residual block in ResNet}
    \label{fig:5.1}
\end{figure}
...
\subsection{Dataset Representation}\label{sec:5.2.2}



\subsection{Primitive Objects and Variations}\label{sec:5.2.3}
...
\begin{table}[H]
    ...
    \label{tbl:5.1}
\end{table}
\subsection{Collecting and Analysing Object Geometric Features}\label{sec:5.2.4}
...
\subsection{Dataset Preprocessing}\label{sec:5.2.5}
...
\subsection{MLP Architecture}\label{sec:5.2.6}



\section{Training}\label{sec:5.3}
...
\section{Evaluation of Results}\label{sec:5.4}
\begin{table}[ht]
    \centering
