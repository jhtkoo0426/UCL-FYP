...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.125\textwidth} p{0.15\textwidth} p{0.1\textwidth} p{0.2\textwidth} p{0.275\textwidth}}
        \toprule
        Paper \& Author & Type(s) of Data & Dataset Size & Approach & Accuracy \\
        \midrule
        Chumbley et al. (2022) \cite{chumbley2022integrating} & Tactile, vision & 10,000 & CNN with ResNet-18 back-bone & 82.7$\pm$0.6 (Known objects); \newline 61.3$\pm$2.8 (Unknown objects) \\
        Garcia et al. (2019) \cite{garciagarcia2019tactilegcn} & Tactile & 5831 & Graph Convolutional Network with k-NN & 75.53 (without k-NN); \newline 92.7 (with k-NN) \\
        Our work & Tactile, vision & 1440 & MLP & 76.3$\pm$0.66 \\
        \bottomrule
    \end{tabular}
