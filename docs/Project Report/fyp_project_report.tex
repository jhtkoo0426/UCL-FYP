...
\begin{figure}[ht]
    \centering
    \includegraphics{docs/Project Report/Media/5_1_kumra_kana_2017_residual_block.png}
...
\section{Experiments on Impacts of Various Features}\label{sec:5.4}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{c *6{>{\Centering}X}}
        ...
        \midrule
        Trial 1 & 70.14 & 60.42 & 64.93 & 73.26 & 76.04 \\
        Trial 2 & 72.57 & 55.56 & 61.46 & 71.18 & 71.53 \\
        Trial 3 & 65.62 & 63.54 & 63.89 & 72.92 & 73.96 \\
        Trial 4 & 70.83 & 60.76 & 64.24 & 71.53 & 76.04 \\
        Trial 5 & 67.71 & 64.58 & 61.81 & 74.31 & 74.65 \\
        \midrule
        Mean    & 69.37 & 60.97 & 63.27 & 72.64 & 74.44 \\
        Std.    & 2.44  & 3.14  & 1.38  & 1.15  & 1.67  \\
        \bottomrule
    \end{tabularx}
    \caption{Mean and standard deviations (std) of accuracies (\%) of various MLP models. The multi-modal dataset only includes tactile and visual data. The complete dataset contains tactile, visual and geometric features.}
    \label{tbl:5.2}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.55]{docs/Project Report/Media/5_3_1_mlp_pca_accuracy_analysis.png}
...
One limitation of this study was the comparatively small sample size employed for data collection, which could have influenced the accuracy of the findings. To address this limitation, future studies should compare the performance of the MLP trained on more extensive datasets. {\color{red} include some results, data used, and approaches for training of some papers}\\
