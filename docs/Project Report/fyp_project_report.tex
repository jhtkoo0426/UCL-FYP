...
\begin{figure}[H]%
    \centering
    \subfloat[\centering Top $k=2$ components; Variance captured: 91.43\%]{{\includegraphics[width=0.35\textwidth]{docs/Project Report/Media/5_2_3_principal_curvature_2d.png} }}%
    \qquad
    \subfloat[\centering Top $k=3$ components; Variance captured: 97.34\%]{{\includegraphics[width=0.35\textwidth]{docs/Project Report/Media/5_2_3_principal_curvature_3d.png} }}%
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.33\textwidth]{docs/Project Report/Media/5_2_5_mlp_architecture.png}
