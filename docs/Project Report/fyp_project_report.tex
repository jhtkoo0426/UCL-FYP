...
Once the robot verifies that the object is stably held, it lifts the object vertically by an offset of $p_z$ to return to $X_n$. Finally, the robot determines and records the outcome of the grasp by detecting the change in the object's z-position $\Delta z$:
...
\begin{figure}[H]%
    \centering
    \subfloat[\centering Invalid tactile data]{{\includegraphics[width=7cm]{docs/Project Report/Media/hand_pose1.png} }}%
    \qquad
    \subfloat[\centering Valid tactile data]{{\includegraphics[width=7cm]{docs/Project Report/Media/hand_pose2.png} }}%
