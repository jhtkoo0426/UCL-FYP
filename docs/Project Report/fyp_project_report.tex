...
\begin{table}[H]
    ...
    \begin{tabular}{llc}
        ...
        \midrule
        Box 1, Box 2 & Box 3 & 51.70\pm1.08  \\
        Box1, Box 3 & Box 2 & 67.80\pm2.65 \\
        Box2, Box 3 & Box 1 & 56.22\pm2.20 \\
        Bottle 1, Bottle 2 & Bottle 3 & 53.96\pm1.15 \\
        Bottle 1, Bottle 3 & Bottle 2 & 56.98\pm0.64 \\
        Bottle 2, Bottle 3 & Bottle 1 & 50.31\pm0.60 \\
        Cylinder 1, Cylinder 2 & Cylinder 3 & 53.46\pm1.05 \\
        Cylinder 1, Cylinder 3 & Cylinder 2 & 57.74\pm2.04\\
        Cylinder 2, Cylinder 3 & Cylinder 1 & 59.00\pm1.50 \\
        \bottomrule
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{lc *5{>{\Centering}X}}
        ...
        \midrule
        Accuracy (\%) & 69.03\pm1.50 & 62.08\pm2.88 & 62.57\pm3.60 & 73.13\pm2.37 & 75.21\pm2.67 \\
        Precision (\%) & 68.71\pm1.40 & 62.53\pm3.40 & 62.44\pm4.81 & 75.08\pm4.72 & 74.95\pm4.28 \\
        Recall (\%) & 72.25\pm2.73 & 62.00\pm4.42 & 61.86\pm3.92 & 73.40\pm2.13 & 73.54\pm2.93 \\
        F1 Score (\%) & 70.39\pm1.03 & 62.13\pm2.81 & 62.02\pm3.47 & 74.12\pm2.44 & 74.15\pm2.79 \\
        \bottomrule
    \end{tabularx}
...
\begin{table}[H]
    ...
    \begin{tabular}{lccccc}
        \toprule
        Mean accuracy & 78.19$\pm$2.23 & 77.08$\pm$0.66 & 76.74$\pm$0.49 & 76.32$\pm$1.43 & 75.83$\pm$2.10 \\
        \midrule
        $k$ & 28 & 15 & 25 & 29 & 27 \\
        \bottomrule
    \end{tabular}
    ...
    \label{tb:5.4}
\end{table}
Since this experimentation aims to balance the trade-off between dataset dimensionality and accuracy, we disregard the corresponding model for $k=28$ and conclude that $k=15$ principal components results in the attainment of the most elevated mean validation accuracy (77.08\% on average across five trials) utilising our MLP model. This selection represents a judicious choice, as it reduces the dimensionality of our dataset from (1440, 512) to (1440, 15), while concurrently preserving and even enhancing the general level of accuracy.
...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.175\textwidth} p{0.15\textwidth} p{0.125\textwidth} p{0.125\textwidth} p{0.275\textwidth}}
        \toprule
        Paper \& Author & Type(s) of Data & Dataset Size & Approach & Accuracy \\
        \midrule
        Chumbley et al. (2022) \cite{chumbley2022integrating} & Tactile (depth, touch), vision & 10,000 & CNN with ResNet-18 back-bone & 82.7$\pm$0.6 (Known objects); \newline 61.3$\pm$2.8 (Unknown objects) \\
        
        Our work & Tactile, vision (EE pose, object features) & 1440 & MLP & 77.08$\pm$0.66 \\
        \bottomrule
    \end{tabular}
